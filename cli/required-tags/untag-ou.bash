...
aws s3api delete-bucket-tagging --bucket codepipeline-us-east-2-671040486051 --profile $AWS_PROFILE
aws s3api delete-bucket-tagging --bucket config-bucket-123133550781 --profile $AWS_PROFILE
aws s3api delete-bucket-tagging --bucket config-rule-code-bucket-123133550781-us-east-2 --profile $AWS_PROFILE
